...
# model settings
model = dict(
    backbone=dict(type='AIM_FLASH_DUAL',drop_path_rate=0.2, adapter_scale=0.5, num_frames=32,pretrained='openaiclip',
                use_flash_attn=True,prompt=True,window_size= (16,7,7)),
...
name='aim_flash_dual_win_prompt'
