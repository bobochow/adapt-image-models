...
model = dict(
    backbone=dict(type='AIM_FLASH_WIN',drop_path_rate=0.2, adapter_scale=1, num_frames=32,pretrained='openaiclip',
                use_flash_attn=True,checkpoint=False,prompt=True,wind_attn=True,window_size= (32,1,1),not_shift=True),
...
project='vitclip_ucf101'
name='aim_flash_tcls_apex_gpunorm'

work_dir = f'./work_dirs/ucf101/{name}'
