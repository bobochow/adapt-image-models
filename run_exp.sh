...
bash tools/dist_train.sh configs/recognition/vit/AIM/AIM_flash_base_hmdb51.py 1 --validate --seed 0 --resume-from work_dirs/hmdb51/vitclip_hmdb51/aim_flash_tcls_7x16_apex_gpunorm_win_prompt_exp3/epoch_20.pth
